...
app.delete('/user/:username', async (req, res) => {
  ...
  try {
    ...
    await client.query('DELETE FROM tasks WHERE executor_id = $1', [username]);
    await client.query('DELETE FROM posts WHERE login = $1', [username]);
    await client.query('DELETE FROM userphoto WHERE login = $1', [username]);
    await client.query('DELETE FROM users WHERE login = $1', [username]);
