...
export const Header = () => {
    ...
    const me = us? JSON.parse(us).login: ''
                ...
                <div className='header'>
                    <nav>
                        <ul>
                            ...
                            <li><Link className={'button'} to={`/profile/${me.login}`}><img src={'/profile.png'} alt={'Oops'} width={20} height={20} /><h5>Профиль</h5></Link></li>
                            <li><Link className={'button'} to={'/'}><img src={'/news.png'} alt={'Oops'} width={20} height={20} /><h5>Новости</h5></Link></li>
                            <li><Link className={'button'} to={'/peoples'}><img src={'/peoples.png'} alt={'Oops'} width={20} height={20} /><h5>Люди</h5></Link></li>
